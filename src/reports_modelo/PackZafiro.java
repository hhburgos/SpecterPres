...
public class PackZafiro {

	public static String ruta = Reports.jrPackZafiro;
	...
	public static String defaultTexto9 = "CREACIÓN Y DIRECCIÓN DE LA ESTRATEGIA DE INFLUENCER MARKETING";
	public static String defaultTexto10 = "1 O 2 SHOOTINGS /MES INCLUIDOS PARA LA CREACIÓN DE CONTENIDO AUDIOVISUAL (INCLUYE PHOTO/VIDEO + DISEÑO RRSS)";
	public static String defaultPrecio1 = "1625€ / MES + IVA";
	public static String defaultPrecio2 = "1599€ / MES + IVA";
	
	String texto1,texto2,texto3,texto4,texto5,texto6,texto7,texto8,texto9,texto10,precio1,precio2;

	public PackZafiro(String texto1, String texto2, String texto3, String texto4, String texto5, String texto6,
			String texto7, String texto8, String texto9, String texto10, String precio1, String precio2) {
		super();
		this.texto1 = texto1;
		this.texto2 = texto2;
		this.texto3 = texto3;
	...
	public static void setDefaultTexto1(String defaultTexto1) {
		PackZafiro.defaultTexto1 = defaultTexto1;
	}
	...
	public static void setDefaultTexto2(String defaultTexto2) {
		PackZafiro.defaultTexto2 = defaultTexto2;
	}
	...
	public static void setDefaultTexto3(String defaultTexto3) {
		PackZafiro.defaultTexto3 = defaultTexto3;
	}
	...
	public static void setDefaultTexto4(String defaultTexto4) {
		PackZafiro.defaultTexto4 = defaultTexto4;
	}
	...
	public static void setDefaultTexto5(String defaultTexto5) {
		PackZafiro.defaultTexto5 = defaultTexto5;
	}
	...
	public static void setDefaultTexto6(String defaultTexto6) {
		PackZafiro.defaultTexto6 = defaultTexto6;
	}
	...
	public static void setDefaultTexto7(String defaultTexto7) {
		PackZafiro.defaultTexto7 = defaultTexto7;
	}
	...
	public static void setDefaultTexto8(String defaultTexto8) {
		PackZafiro.defaultTexto8 = defaultTexto8;
	}
	...
	public static void setDefaultTexto9(String defaultTexto9) {
		PackZafiro.defaultTexto9 = defaultTexto9;
	}

	public static String getDefaultTexto10() {
		return defaultTexto10;
	}

	public static void setDefaultTexto10(String defaultTexto10) {
		PackZafiro.defaultTexto10 = defaultTexto10;
	}
	...
	public static void setDefaultPrecio1(String defaultPrecio1) {
		PackZafiro.defaultPrecio1 = defaultPrecio1;
	}
	...
	public static void setDefaultPrecio2(String defaultPrecio2) {
		PackZafiro.defaultPrecio2 = defaultPrecio2;
	}
	...
	public String toString() {
		return "PackZafiro [texto1=" + texto1 + ", texto2=" + texto2 + ", texto3=" + texto3 + ", texto4=" + texto4
				+ ", texto5=" + texto5 + ", texto6=" + texto6 + ", texto7=" + texto7 + ", texto8=" + texto8
				+ ", texto9=" + texto9 + ", texto10=" + texto10 + ", precio1=" + precio1 + ", precio2=" + precio2 + "]";
	}
